...
namespace PIO.Models
{
	...
	public enum BuildingTypeIDs : int { Factory = 0 , Reserved1 = 1 , Reserved2 = 1 };
	public enum TaskTypeIDs : int { Idle=0, Produce = 1, MoveTo = 2, CarryTo = 3,CreateBuilding=4,Build=5 };
