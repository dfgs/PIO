...
namespace PIO.Console.ViewModels
{
	public class ProduceOrdersViewModel : PIOViewModelCollection<ProduceOrderViewModel,ProduceOrder>
	{
		...
		public ProduceOrdersViewModel(PIOServiceClient PIOClient, BotsRESTClient BotsClient, ITranslationModule TranslationModule, int PlanetID) : base(PIOClient, BotsClient,TranslationModule)
		{
