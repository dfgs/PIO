...
namespace PIO.ServerLib.Modules
{
	public class FactoryTypeModule : DatabaseModule,IFactoryTypeModule
	{
		...
		public FactoryType GetFactoryType(FactoryTypeIDs FactoryTypeID)
		{
			...
			query=new Select(FactoryTypeTable.FactoryTypeID,  FactoryTypeTable.Name, FactoryTypeTable.MaterialSetID, FactoryTypeTable.HealthPoints,FactoryTypeTable.BuildSteps).From(PIODB.FactoryTypeTable).Where(FactoryTypeTable.FactoryTypeID.IsEqualTo(FactoryTypeID));
		...
		public FactoryType[] GetFactoryTypes()
		{
			...
			query=new Select(FactoryTypeTable.FactoryTypeID,  FactoryTypeTable.Name, FactoryTypeTable.MaterialSetID, FactoryTypeTable.HealthPoints, FactoryTypeTable.BuildSteps).From(PIODB.FactoryTypeTable);
