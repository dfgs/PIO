		...
		protected override IEnumerable<IQuery> OnUpgradeTo(int Version)
		{
			...
			switch (Version)
			{
				case 1:
					...
					yield return new CreateTable(PIODB.BuildingTable, BuildingTable.BuildingID, BuildingTable.PlanetID, BuildingTable.X,BuildingTable.Y, BuildingTable.BuildingTypeID, BuildingTable.HealthPoints,BuildingTable.RemainingBuildSteps);
					...
					yield return new CreateTable(PIODB.TaskTable, TaskTable.TaskID,TaskTable.TaskTypeID, TaskTable.WorkerID,TaskTable.X,TaskTable.Y, TaskTable.TargetFactoryID,TaskTable.ResourceTypeID,TaskTable.FactoryTypeID,  TaskTable.ETA);
