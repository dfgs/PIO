...
namespace PIO.ServerLib.Tables
{
	...
	public class FarmTypeTable : Table
	{
		public static readonly Column<FarmTypeIDs> FarmTypeID = new Column<FarmTypeIDs>() { Constraint = NetORMLib.ColumnConstraints.PrimaryKey };
