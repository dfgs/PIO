...
namespace PIO.UnitTest.WebServiceLib
{
	...
	public class PIOServiceUnitTest
	{
		...
		public void ShouldGetPlanet()
		{
			...
			service = new PIOService(NullLogger.Instance, new MockedPlanetModule(3, false), null, null,null, null, null, null, null, null, null, null, null, null,null);
		...
		public void ShouldNotGetPlanetAndLogError()
		{
			...
			service = new PIOService(logger,new MockedPlanetModule(3, true), null, null, null, null, null, null, null, null, null, null, null, null, null);
		...
		public void ShouldGetFactory()
		{
			...
			service = new PIOService(NullLogger.Instance, null, new MockedFactoryModule(3, false), null, null, null, null, null, null, null, null, null, null, null, null);
		...
		public void ShouldNotGetFactoryAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger,null, new MockedFactoryModule(3, true),  null, null, null, null, null, null, null, null, null, null, null, null);
		...
		public void ShouldGetWorker()
		{
			...
			service = new PIOService(NullLogger.Instance, null, null, new MockedWorkerModule(3, false), null, null, null, null, null, null, null, null, null, null, null);
		...
		public void ShouldNotGetWorkerAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger, null, null, new MockedWorkerModule(3, true), null, null, null, null, null, null, null, null, null, null, null);
		...
		public void ShouldGetStack()
		{
			...
			service = new PIOService(NullLogger.Instance, null, null, null, new MockedStackModule(3, false), null, null, null, null, null, null, null, null, null, null);
		...
		public void ShouldNotGetStackAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger, null, null, null, new MockedStackModule(3, true), null, null, null, null, null, null, null, null, null, null);
		...
		public void ShouldGetResourceType()
		{
			...
			service = new PIOService(NullLogger.Instance, null, null, null, null, new MockedResourceTypeModule(3, false), null, null, null, null, null, null, null, null, null);
		...
		public void ShouldNotGetResourceTypeAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger, null, null, null, null, new MockedResourceTypeModule(3, true),  null, null, null, null, null, null, null, null, null);
		...
		public void ShouldGetFactoryType()
		{
			...
			service = new PIOService(NullLogger.Instance, null, null, null, null, null, new MockedFactoryTypeModule(3, false), null, null, null, null, null, null, null, null);
		...
		public void ShouldNotGetFactoryTypeAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger, null, null, null, null, null, new MockedFactoryTypeModule(3, true), null, null, null, null, null, null, null, null);
		...
		public void ShouldGetTaskType()
		{
			...
			service = new PIOService(NullLogger.Instance, null, null, null, null, null, null, new MockedTaskTypeModule(3, false),null, null, null, null, null, null, null);
		...
		public void ShouldNotGetTaskTypeAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger, null, null, null, null, null, null, new MockedTaskTypeModule(3, true),null, null, null, null, null, null, null);
		...
		public void ShouldGetMaterial()
		{
			...
			service = new PIOService(NullLogger.Instance, null, null, null, null, null, null, null, new MockedMaterialModule(3, false),   null, null, null, null, null, null);
		...
		public void ShouldNotGetMaterialAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger, null, null, null, null, null, null, null, new MockedMaterialModule(3, true),   null, null, null, null, null, null);
		...
		public void ShouldGetIngredient()
		{
			...
			service = new PIOService(NullLogger.Instance, null, null, null, null, null, null, null, null, new MockedIngredientModule(3, false), null, null, null, null, null);
		...
		public void ShouldNotGetIngredientAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger, null, null, null, null, null, null, null, null, new MockedIngredientModule(3, true), null, null, null, null, null);
		...
		public void ShouldGetProduct()
		{
			...
			service = new PIOService(NullLogger.Instance, null, null, null, null, null, null, null, null, null, new MockedProductModule(3, false),  null, null, null, null);
		...
		public void ShouldNotGetProductAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger, null, null, null, null, null, null, null, null, null, new MockedProductModule(3, true),null, null, null, null);
		...
		public void ShouldGetHasEnoughResourcesToProduce()
		{
			...
			service = new PIOService(NullLogger.Instance, null, null, null, null, null, null, null, null, null, null, null, new MockedResourceCheckerModule(false, true), null, null);
			result = service.HasEnoughResourcesToProduce(1);
			Assert.IsTrue(result);

			service = new PIOService(NullLogger.Instance, null, null, null, null, null, null, null, null, null, null, null, new MockedResourceCheckerModule(false, false), null, null);
			result = service.HasEnoughResourcesToProduce(1);
		...
		public void ShouldNotGetHasEnoughResourcesToProduceAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger, null, null, null, null, null, null, null, null, null, null, null, new MockedResourceCheckerModule(true,true), null, null);
		...
		public void ShouldProduce()
		{
			...
			service = new PIOService(NullLogger.Instance, null, null, null, null, null, null, null, null, null, null, null, null,new MockedProducerModule(false), null);
		...
		public void ShouldNotProduceAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger, null, null, null, null, null, null, null, null, null, null, null,  null, new MockedProducerModule(true), null);
		...
		public void ShouldMove()
		{
			...
			service = new PIOService(NullLogger.Instance, null, null, null, null, null, null, null, null, null, null, null, null, null, new MockedMoverModule(false));
		...
		public void ShouldNotMoveAndLogError()
		{
			...
			logger = new MemoryLogger(new DefaultLogFormatter());
			service = new PIOService(logger, null, null, null, null, null, null, null, null, null, null, null, null, null, new MockedMoverModule(true));
